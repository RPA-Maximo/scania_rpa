...
DDL_STATEMENTS = {
    ...
    "purchase_order": """
        CREATE TABLE IF NOT EXISTS `purchase_order` (
            ...
            `supplier_address`    VARCHAR(500)  NULL                         COMMENT '供应商地址1',
            `supplier_address2`   VARCHAR(500)  NULL                         COMMENT '供应商地址2',
            `supplier_zip`        VARCHAR(20)   NULL                         COMMENT '供应商邮政编码',
            `supplier_city`       VARCHAR(100)  NULL                         COMMENT '供应商城市',
            `supplier_state`      VARCHAR(100)  NULL                         COMMENT '供应商省/区',
    ...
    "purchase_order_bd": """
        CREATE TABLE IF NOT EXISTS `purchase_order_bd` (
            ...
            `model_num`       VARCHAR(200)  NULL                         COMMENT '型号（cxtypedsg from MXAPIITEM）',
            `size_info`       VARCHAR(500)  NULL                         COMMENT '尺寸/规格（catalogcode/description from MXAPIITEM）',
            `item_code`       VARCHAR(50)   NULL                         COMMENT '物料编号原始值（itemnum）',
            `discount_pct`    VARCHAR(20)   NULL                         COMMENT '折扣%（polinediscpct）',
            `currency`        VARCHAR(10)   NULL                         COMMENT '行级货币',
